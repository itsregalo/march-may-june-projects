"""
a DNQ reinforcement learning agent for a car to drive on a track (any random design) 
by avoiding obstacles (stones, trees) and reach from on point to another.
The road will have obstacles like rocks, trees such that the car avoids these obstacles and reaches point
"""
